...
def parse_petput(data, **kwargs):
    ...
    if temp_7262:
        dependencies.set_variable("_pet_put_id", temp_7262)
...
def parse_petpost(data, **kwargs):
    ...
    # Try to extract each dynamic object
        ...
        try:
            temp_5581 = str(data["photoUrls"][0])
    ...
    # If no dynamic objects were extracted, throw.
    if not (temp_8173 or temp_7680 or temp_5581 or temp_2060):
        raise ResponseParsingException("Error: all of the expected dynamic objects were not present in the response.")

    # Set dynamic variables
    if temp_8173:
        dependencies.set_variable("_pet_post_id", temp_8173)
    if temp_7680:
        dependencies.set_variable("_pet_post_name", temp_7680)
    if temp_5581:
        dependencies.set_variable("_pet_post_photoUrls_0", temp_5581)
    if temp_2060:
        dependencies.set_variable("_pet_post_status", temp_2060)
...
request = requests.Request([
    ...
    primitives.restler_basepath("/api/v3"),
